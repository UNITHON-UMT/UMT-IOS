...
//    public class func topViewController(controller: UIViewController? = UIApplication.shared.keyWindow?.rootViewController, complete: @escaping (UIViewController?) -> Void) {
    public class func topViewController(
        controller: UIViewController? = UIApplication.shared.openSessions.first?.scene?.inputView?.window?.rootViewController,
        complete: @escaping (UIViewController?) -> Void) {
    ...
    public class func topViewController(complete: @escaping (UIViewController?) -> Void) {
        ...
        DispatchQueue.main.async {
            ...
            let controller = UIApplication.shared.openSessions.first?.scene?.inputView?.window?.rootViewController
